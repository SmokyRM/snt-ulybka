...
const navConfig: OfficeNavItem[] = [
  ...
  { key: "tasks", href: "/office/tasks", label: "Поручения", rolesAllowed: ["chairman", "secretary", "admin"], testId: "office-nav-tasks" },
  ...
  { key: "debts-report", href: "/office/reports/debts", label: "Отчёт по долгам", rolesAllowed: ["chairman", "accountant", "admin"], testId: "office-nav-debts-report" },
