  ...
  return (
    <main className="space-y-12 bg-[#F8F1E9] pb-16 pt-8 sm:space-y-16 sm:pb-20 sm:pt-12">
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-zinc-700">
              В разделах ниже собраны инструкции по оплате электроэнергии и взносов,
              реквизиты и ответы на вопросы.
            </p>
      ...
      <section id="news" className="py-2">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-zinc-700">
              Официальные объявления и информация публикуются в новостях сайта и
              официальных каналах СНТ.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="appeal" className="py-2">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-zinc-900">Обращения</h2>
            <p className="mt-2 text-sm text-zinc-700">
              Форма обращений будет добавлена позже. Пока связаться с правлением можно
      ...
      <section id="contacts" className="py-2">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-zinc-700">
              Следите за обновлениями СНТ «Улыбка» в официальных сообществах.
            </p>
