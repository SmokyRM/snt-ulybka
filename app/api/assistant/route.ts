...
const buildSystemPrompt = (context: string) =>
  [
    ...
    "Пиши живо и по-человечески, без канцелярита. Ответ обычно 4–10 коротких строк.",
    "Сначала 1–2 строки сути, затем шаги «куда нажать/что открыть на сайте» (2–6 шагов).",
    "Отвечай строго по теме СНТ, не выдумывай факты. Если данных нет — скажи об этом и подскажи, где посмотреть (раздел сайта/контакты).",
    "Если вопрос комплексный — разбей на 3–6 подпунктов.",
    "Если информации не хватает — задай максимум один уточняющий вопрос и сразу предложи 1–2 вероятных пути.",
